...
# 获取训练集
def get_train_data(batch_size=10, time_step=1, train_begin=0, train_end=901):
    batch_index = []
...
# 获取测试集
def get_test_data(time_step=1, test_begin=901):
...
def train_lstm(batch_size=10, time_step=1, train_begin=0, train_end=901):
    ...
    with tf.Session() as sess:
        ...
        plt.plot(list(range(100)), loss123, color='r')
        plt.show()
    return loss123
